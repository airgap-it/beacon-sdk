...
export class TezosTezlinkBlockchain implements Blockchain {
  public readonly identifier: string = 'xtz-tezlink'
  ...
  async getAccountInfosFromPermissionResponse(
    _permissionResponse: PermissionResponseV3<'tezos-tezlink'>
