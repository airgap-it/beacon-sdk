...
export const tezosWebList: WebApp[] = [
  {
    ...
    links: {
      [NetworkType.MAINNET]: 'http://localhost:4200/',
      [NetworkType.GHOSTNET]: 'http://localhost:4200/',
      [NetworkType.MONDAYNET]: 'http://localhost:4200/',
      [NetworkType.DAILYNET]: 'http://localhost:4200/',
      [NetworkType.DELPHINET]: 'http://localhost:4200/',
      [NetworkType.EDONET]: 'http://localhost:4200/',
      [NetworkType.FLORENCENET]: 'http://localhost:4200/',
      [NetworkType.GRANADANET]: 'http://localhost:4200/',
      [NetworkType.HANGZHOUNET]: 'http://localhost:4200/',
      [NetworkType.ITHACANET]: 'http://localhost:4200/',
      [NetworkType.JAKARTANET]: 'http://localhost:4200/',
      [NetworkType.KATHMANDUNET]: 'http://localhost:4200/',
      [NetworkType.LIMANET]: 'http://localhost:4200/',
      [NetworkType.MUMBAINET]: 'http://localhost:4200/',
      [NetworkType.NAIROBINET]: 'http://localhost:4200/',
      [NetworkType.OXFORDNET]: 'http://localhost:4200/'
    }
  },
  {
    key: 'kukai_web',
