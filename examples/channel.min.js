!(function r(o, i, s) {
  ...
  for (var u = 'function' == typeof require && require, e = 0; e < s.length; e++) a(s[e])
  return a
})(
  {
    1: [
      function (e, t, n) {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.enforceOptions = function (e) {
            r = e
          }),
          (n.BroadcastChannel = void 0)
        var r,
          o = e('./util.js'),
          i = e('./method-chooser.js'),
          s = e('./options.js'),
          e = function (e, t) {
            var n
            ;(this.name = e),
              (this.options = (0, s.fillOptionsWithDefaults)((t = r ? r : t))),
              (this.method = (0, i.chooseMethod)(this.options)),
              (this._iL = !1),
              (this._onML = null),
              ...
              (this._befC = []),
              (this._prepP = null),
              (t = (n = this).method.create(n.name, n.options)),
              (0, o.isPromise)(t)
                ? (n._prepP = t).then(function (e) {
                    n._state = e
                  })
                : (n._state = t)
          }
        function a(t, e, n) {
          var r = { time: t.method.microSeconds(), type: e, data: n }
        ...
        ;((n.BroadcastChannel = e)._pubkey = !0),
          (e.prototype = {
            ...
            set onmessage(e) {
              var t = { time: this.method.microSeconds(), fn: e }
              l(this, 'message', this._onML),
                e && 'function' == typeof e
                  ? ((this._onML = t), c(this, 'message', t))
                  : (this._onML = null)
            },
            addEventListener: function (e, t) {
              var n = this.method.microSeconds()
              c(this, e, { time: n, fn: t })
            },
      ...
      { './method-chooser.js': 6, './options.js': 12, './util.js': 13 }
    ],
    2: [
      function (e, t, n) {
        'use strict'
        var r = e('./index.es5.js'),
          e = r.BroadcastChannel,
          r = r.createLeaderElection
    ...
    4: [
      function (e, t, n) {
        ...
        var r = e('./broadcast-channel'),
          o = e('./leader-election')
      },
      { './broadcast-channel': 1, './leader-election': 5 }
    ],
    5: [
      function (e, t, n) {
        'use strict'
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.beLeader = u),
          (n.createLeaderElection = function (e, t) {
            if (e._leaderElector) throw new Error('BroadcastChannel already has a leader-elector')
            t = (function (e, t) {
              e = e || {}
              ;(e = JSON.parse(JSON.stringify(e))).fallbackInterval || (e.fallbackInterval = 3e3)
        ...
        function a(e, t) {
          t = { context: 'leader', action: t, token: e.token }
          return e._channel.postInternal(t)
        }
        function u(t) {
          t.isLeader = !0
          var e = o.default.add(function () {
            return t.die()
          })
          t._unl.push(e)
          e = function (e) {
            'leader' === e.context && 'apply' === e.action && a(t, 'tell'),
              'leader' !== e.context ||
                'tell' !== e.action ||
                t._dpLC ||
                ((t._dpLC = !0), t._dpL(), a(t, 'tell'))
          }
          return t._channel.addEventListener('internal', e), t._lstns.push(e), a(t, 'tell')
        }
        s.prototype = {
          applyOnce: function () {
            var t = this
            ...
            function n(e) {
              'leader' === e.context &&
                e.token != t.token &&
                (o.push(e),
                'apply' === e.action && e.token > t.token && (r = !0),
                'tell' === e.action && (r = !0))
            }
            var r = !(this._isApl = !0),
              o = []
            return (
              ...
              a(this, 'apply')
                .then(function () {
                  return (0, i.sleep)(t._options.responseTime)
                })
                .then(function () {
                  ...
                  : new Promise(function (e) {
                      ...
                      function n() {
                        t ||
                          ((t = !0),
                          clearInterval(r),
                          i._channel.removeEventListener('internal', o),
                          e(!0))
                      }
      ...
      { './util.js': 13, '@babel/runtime/helpers/interopRequireDefault': 14, unload: 19 }
    ],
    6: [
      function (e, t, n) {
        'use strict'
        var r = e('@babel/runtime/helpers/interopRequireDefault')
        Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.chooseMethod = function (t) {
            var e = [].concat(t.methods, u).filter(Boolean)
            if (t.type) {
        ...
        var o = r(e('./methods/native.js')),
          i = r(e('./methods/indexed-db.js')),
          n = r(e('./methods/localstorage.js')),
          s = r(e('./methods/simulate.js')),
          a = e('./util'),
          u = [o.default, i.default, n.default]
        !a.isNode ||
          ('function' == typeof (e = e('../../src/methods/node.js')).canBeUsed && u.push(e))
      },
      {
    ...
    7: [
      function (e, t, n) {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.createDatabase = l),
          (n.writeMessage = d),
          (n.getAllMessages = function (e) {
            var n = e.transaction(u).objectStore(u),
              r = []
          ...
          (n.getMessagesHigherThan = f),
          (n.removeMessageById = h),
          (n.getOldMessages = p),
          (n.cleanOldMessages = m),
          (n.create = v),
          (n.close = g),
          (n.postMessage = _),
          (n.onMessage = w),
          (n.canBeUsed = y),
          (n.averageResponseTime = L),
          (n.default = n.type = n.microSeconds = void 0)
        var o = e('../util.js'),
          i = r(e('../oblivious-set')),
          s = e('../options'),
          e = o.microSeconds
        n.microSeconds = e
        var a = 'pubkey.broadcast-channel-0-',
          u = 'messages'
        function c() {
        ...
        function l(e) {
          ...
          return (
            (n.onupgradeneeded = function (e) {
              e.target.result.createObjectStore(u, { keyPath: 'id', autoIncrement: !0 })
            }),
        ...
        function d(e, t, n) {
          var r = { uuid: t, time: new Date().getTime(), data: n },
            o = e.transaction([u], 'readwrite')
          return new Promise(function (e, t) {
            ;(o.oncomplete = function () {
              ...
              o.objectStore(u).add(r)
          })
        }
        function f(e, n) {
          var r = e.transaction(u).objectStore(u),
            o = []
          return new Promise(function (t) {
            ;(function () {
              try {
        ...
        function h(e, t) {
          var n = e.transaction([u], 'readwrite').objectStore(u).delete(t)
        ...
        function p(e, t) {
          var r = new Date().getTime() - t,
            o = e.transaction(u).objectStore(u),
            i = []
        ...
        function v(n, r) {
          return (
            (r = (0, s.fillOptionsWithDefaults)(r)),
            l(n).then(function (e) {
              var t = {
                closed: !1,
                lastCursorId: 0,
                channelName: n,
                options: r,
                uuid: (0, o.randomToken)(),
                eMIs: new i.default(2 * r.idb.ttl),
              ...
              return (
                (e.onclose = function () {
                  ;(t.closed = !0), r.idb.onclose && r.idb.onclose()
                }),
                (function e(t) {
                  if (t.closed) return
                  b(t)
                    .then(function () {
                      return (0, o.sleep)(t.options.idb.fallbackInterval)
                    })
                    .then(function () {
                      return e(t)
                    })
        ...
        function b(n) {
          return !n.closed && n.messagesCallback
            ? f(n.db, n.lastCursorId).then(function (e) {
                return (
                  e
                    .filter(function (e) {
                      return !!e
        ...
        function _(e, t) {
          return (
            (e.writeBlockPromise = e.writeBlockPromise
              .then(function () {
                return d(e.db, e.uuid, t)
              })
              .then(function () {
                0 === (0, o.randomInt)(0, 10) && m(e.db, e.options.idb.ttl)
              })),
            e.writeBlockPromise
          )
        }
    ...
    8: [
      function (e, t, n) {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.storageKey = c),
          (n.postMessage = l),
          (n.addStorageEventListener = d),
          (n.removeStorageEventListener = f),
          (n.create = h),
          (n.close = p),
          (n.onMessage = m),
          (n.canBeUsed = v),
          (n.averageResponseTime = b),
          (n.default = n.type = n.microSeconds = void 0)
        var i = r(e('../oblivious-set')),
          s = e('../options'),
          a = e('../util'),
          r = a.microSeconds
        n.microSeconds = r
        var o = 'pubkey.broadcastChannel-',
          e = 'localstorage'
        function u() {
          var e
        ...
        function d(e, t) {
          ...
          return window.addEventListener('storage', e), e
        }
        function f(e) {
          window.removeEventListener('storage', e)
        }
        function h(e, t) {
          if (((t = (0, s.fillOptionsWithDefaults)(t)), !v()))
            throw new Error('BroadcastChannel: localstorage cannot be used')
          var n = (0, a.randomToken)(),
            r = new i.default(t.localstorage.removeTimeout),
            o = { channelName: e, uuid: n, eMIs: r }
          return (
            (o.listener = d(e, function (e) {
              o.messagesCallback &&
                e.uuid !== n &&
                e.token &&
                !r.has(e.token) &&
                ((e.data.time && e.data.time < o.messagesCallbackTime) ||
                  (r.add(e.token), o.messagesCallback(e.data)))
            })),
            o
          )
        }
    ...
    9: [
      function (e, t, n) {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.onMessage = a),
          (n.canBeUsed = u),
          (n.averageResponseTime = c),
          (n.default = n.type = n.microSeconds = void 0)
        var r = e('../util'),
          e = r.microSeconds
        n.microSeconds = e
        function o(e) {
          var t = { messagesCallback: null, bc: new BroadcastChannel(e), subFns: [] }
          return (
    ...
    10: [
      function (e, t, n) {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.averageResponseTime = l),
          (n.default = n.type = n.microSeconds = void 0)
        var r = e('../util').microSeconds
        n.microSeconds = r
        e = 'simulate'
        n.type = e
        var o = new Set()
        function i(e) {
          e = { name: e, messagesCallback: null }
          return o.add(e), e
        }
        function s(e) {
          o.delete(e)
      ...
      function (e, t, n) {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.fillOptionsWithDefaults = function () {
            ...
            t.localstorage.removeTimeout || (t.localstorage.removeTimeout = 6e4)
            e.methods && (t.methods = e.methods)
            t.node || (t.node = {})
            t.node.ttl || (t.node.ttl = 12e4)
          ...
          !function () {
            ...
            Object.defineProperty(o, '__esModule', { value: !0 }),
              ...
              (o.microSeconds = function () {
                ...
                return e === t ? 1e3 * e + ++n : ((n = 0), 1e3 * (t = e))
              }),
              (o.isNode = void 0)
            var t = 0,
              n = 0
            var e = '[object process]' === Object.prototype.toString.call(void 0 !== r ? r : 0)
            o.isNode = e
          }.call(this)
    ...
    18: [
      function (e, t, n) {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.default = {
            add: function (e) {
              ;('function' == typeof WorkerGlobalScope && self instanceof WorkerGlobalScope) ||
    ...
    19: [
      function (e, t, n) {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.getSize = f),
          (n.default = void 0)
        var o = r(e('detect-node')),
          i = r(e('./browser.js')),
          e = r(e('./node.js')),
          s = (o.default ? e : i).default,
          a = new Set(),
          u = !1
        function c(e) {
          if ((u || ((u = !0), s.add(l)), 'function' != typeof e))
        ...
        n.default = { add: c, runAll: l, removeAll: d, getSize: f }
      },
      {
        './browser.js': 18,
        './node.js': 15,
